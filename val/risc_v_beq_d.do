...
add wave -noupdate -color Magenta /RISC_V_Pipeline_rst_tb/DUT/CORE/D_Branch
...
add wave -noupdate -color Magenta /RISC_V_Pipeline_rst_tb/DUT/CORE/E_Branch
...
add wave -noupdate -color Magenta /RISC_V_Pipeline_rst_tb/DUT/CORE/E_Branch_H
...
add wave -noupdate -divider BEQ
add wave -noupdate -divider {CTRL + REG}
add wave -noupdate /RISC_V_Pipeline_rst_tb/DUT/clk
add wave -noupdate -color Cyan -itemcolor Cyan /RISC_V_Pipeline_rst_tb/DUT/CORE/D_PC
add wave -noupdate -color Gold -itemcolor Gold /RISC_V_Pipeline_rst_tb/DUT/CORE/D_InstrData
add wave -noupdate -color Magenta /RISC_V_Pipeline_rst_tb/DUT/CORE/D_Branch
...
add wave -noupdate /RISC_V_Pipeline_rst_tb/DUT/CORE/SU_D/In_0
